...
namespace OpenVisionLab.Core
{
    ...
    {
        public static Bitmap ToBitmap(OpenCvSharp.Mat image) => OpenVisionLab.Core.Imaging.BitmapConverter.ToBitmap(image);
        public static Mat ToMat(Bitmap image) => OpenVisionLab.Core.Imaging.BitmapConverter.ToMat(image);
